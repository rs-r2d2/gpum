...
| **II. Platform Parity** | ❌ VIOLATION → ✅ **RESOLVED 2026-08-17** | macOS deferred; constitution stated all three platforms. Closed by constitution amendment 2.0.0, which narrows Principle II to Linux only. See Complexity Tracking below. |
